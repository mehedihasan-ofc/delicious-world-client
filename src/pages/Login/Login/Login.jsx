    ...
    return (
        <div className="flex justify-center items-center h-full p-8">
            <div className="bg-white shadow-lg rounded p-6 w-[400px]">
                ...
                <p className='text-center mt-3 font-semibold'>New to Delicious World? <Link to='/register' className='text-yellow-500'>Sign Up</Link></p>
                ...
                <div className='mt-2'>
                    ...
                    <div className='border p-2 rounded-full'>
                        <button onClick={handleGithubLogin} className='flex items-center justify-center w-full'>
